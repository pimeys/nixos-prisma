...
let
  sources = {
    ...
    "electron-to-chromium-1.4.430" = {
      ...
      version = "1.4.430";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.430.tgz";
        sha512 = "FytjTbGwz///F+ToZ5XSeXbbSaXalsVRXsz2mHityI5gfxft7ieW3HqFLkU5V1aIrY42aflICqbmFoDxW10etg==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.430"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2308";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2308.tgz";
      sha512 = "DKf/ERUSoCkx0abalgYeJ02V2hrmu61/ss6nky4IIKn3CSRJKgwd4tB4kBKhw0fLHwdTQV6/Cp5Rtg0XR7u+vA==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
