...
let
  sources = {
    ...
    "electron-to-chromium-1.4.358" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.358";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.358.tgz";
        sha512 = "dbqpWy662dGVwq27q8i6+t5FPcQiFPs/VExXJ+/T9Xp9KUV0b5bvG+B/i07FNNr7PgcN3GhZQCZoYJ9EUfnIOg==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.358"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2048";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2048.tgz";
      sha512 = "G/7sFJv9/Oagvhu82GV47y0qljkD+XC7DR7FR4YmOC7XkSHNZH6+My5cxbaAOwA1DcbxHyE+USFGtolgvWgBwg==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.21.4"
