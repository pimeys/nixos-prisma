...
let
  sources = {
    ...
    "electron-to-chromium-1.4.758" = {
      ...
      version = "1.4.758";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.758.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.758"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3613";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3613.tgz";
      sha512 = "iq1YM6ur0EjaeQrmuRV3CtFSzi3clIjUmacdI1/mfiH4J7rHTWUdbG0HFCfQGmITqzwIHoUwP6ix9VipTHfynw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.2"
