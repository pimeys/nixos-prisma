...
let
  sources = {
    ...
    "caniuse-lite-1.0.30001496" = {
      name = "caniuse-lite";
      packageName = "caniuse-lite";
      version = "1.0.30001496";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001496.tgz";
        sha512 = "s130TIk2iZK+NLA6dd1hyeOtUco9ZXkOqb/lSFoBQQYjsK5GSnHMwdYU0cDxERV+IVbQdtHi5uStCPR+FaC7Xw==";
      };
    };
    "chalk-2.4.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.425" = {
      ...
      version = "1.4.425";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.425.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001496"
      sources."chalk-2.4.2"
      ...
      sources."electron-to-chromium-1.4.425"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2294";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2294.tgz";
      sha512 = "25B+rUZ3k3k6Qn/raOa54MSPKHyN4l56m9buWUKPqsR8wBle6bFkG/H23s2rlZcDI6v7T1ZX4M7kcWZOYnB4Ug==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
