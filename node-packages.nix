...
let
  sources = {
    ...
    "@babel/helper-module-imports-7.24.1" = {
      ...
      version = "7.24.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@babel/helper-module-imports/-/helper-module-imports-7.24.1.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."@babel/helper-module-imports-7.24.1"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3470";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3470.tgz";
      sha512 = "V41smMKamukVnkVmtrxfdWZsqi530XJJKa3NEa2SoTUXKW50Lc85hjMo13LrWxCI2eXEcRJb3EpoUKMq8rWDAw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.1"
