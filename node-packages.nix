...
let
  sources = {
    ...
    "@prisma/prisma-schema-wasm-5.18.0-25.4c784e32044a8a016d99474bd02a3b6123742169" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.18.0-25.4c784e32044a8a016d99474bd02a3b6123742169.tgz";
        sha512 = "2h7MDiYVXHVSdz0CylOUktVouPHRKUw5ciXz2r/oZsO2T6Zycez/eSvh4SKiKbHuxDq6SSb3R97mO7bjzh+NVQ==";
      };
    };
    "@prisma/prisma-schema-wasm-5.19.0-26.8a3982b39f6dc8065ba99a0d212b3e18a5cd2d1d" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "5.19.0-26.8a3982b39f6dc8065ba99a0d212b3e18a5cd2d1d";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.19.0-26.8a3982b39f6dc8065ba99a0d212b3e18a5cd2d1d.tgz";
        sha512 = "w1HGHJjYyoPAKtaiwiPXD4w5sMMlGmbVvjXE+xXh0hC9y1ZbIVAHYTJtdUDtNxmU9QmE0valRReK8GZLllnKWw==";
      };
    };
    "@prisma/schema-files-loader-5.18.0" = {
      ...
      version = "5.18.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.18.0.tgz";
        sha512 = "JtjPOZ8odMMr3etCcQ5kDsuljmckuNNCRMJglouPWSyzRbv4nOQJZCD4qPmoMUSoX0gwV7wGgwUw50XsoFYVzA==";
      };
    };
    "@prisma/schema-files-loader-5.19.0-dev.15" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "5.19.0-dev.15";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.19.0-dev.15.tgz";
        sha512 = "wEcKYQWpUnIGb2dAK0GhXNxt5RTa+HGRmnT6znsRe2Cvtfgn70oKXjhjIGCP1+GjRn77m6MySTNxMQapXziefQ==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "5.18.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-5.18.0.tgz";
      sha512 = "RzLf5EPsa2m4WQWGKcLXhtme2aD1I5VX4nlckCM/am5k+YgBuruQdg/yIzdTrDOVkj10/KSp07VV+NkfTwOnHw==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.18.0-25.4c784e32044a8a016d99474bd02a3b6123742169"
      sources."@prisma/schema-files-loader-5.18.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7024";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7024.tgz";
      sha512 = "OVcrSzxusLmnqBeLTMxb2Cs1z9LazHAHBsj8ZEQhLclSF28zkG44Kzjx9HdvpUEjviD3Wckhocob4gHo6k2fTw==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.19.0-26.8a3982b39f6dc8065ba99a0d212b3e18a5cd2d1d"
      sources."@prisma/schema-files-loader-5.19.0-dev.15"
      sources."@types/js-levenshtein-1.1.3"
      sources."fs-extra-11.1.1"
      sources."graceful-fs-4.2.11"
      sources."js-levenshtein-1.1.6"
