...
let
  sources = {
    ...
    "@prisma/config-6.8.2" = {
      ...
      version = "6.8.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.8.2.tgz";
        sha512 = "ZJY1fF4qRBPdLQ/60wxNtX+eu89c3AkYEcP7L3jkp0IPXCNphCYxikTg55kPJLDOG6P0X+QG5tCv6CmsBRZWFQ==";
      };
    };
    "@prisma/config-6.9.0-dev.33" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.9.0-dev.33";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.9.0-dev.33.tgz";
        sha512 = "Pyt7UHOfeDkzB/HtFBg3PHdUKnmJY1PuSZnEr1TI+ZCXNbwu4uG3XvY1PDKa515NPzFKErLHs6v0/C1wA1JsfQ==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.8.0-43.2060c79ba17c6bb9f5823312b6f6b7f4a845738e" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.8.0-43.2060c79ba17c6bb9f5823312b6f6b7f4a845738e.tgz";
        sha512 = "s2pYG3FWY1ICGN6TVu/DrzwZWzn4oyeOZnJI8CG5fJey7i3r8EtxiBB9R9ahwL0Kqg+5KAYn37V2kVCu/9+Y/g==";
      };
    };
    "@prisma/prisma-schema-wasm-6.8.0-44.f31fc955f15addd30e95835648a3613d9068c631" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.8.0-44.f31fc955f15addd30e95835648a3613d9068c631";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.8.0-44.f31fc955f15addd30e95835648a3613d9068c631.tgz";
        sha512 = "ZC9/vzPGp+tpZ6apW2hRk1IarH4Gsyn+2lrQfCiODQ3hTaZZ/XyQR8he/QeUH758m/F5w7l2bkcnxTTcndqDiw==";
      };
    };
    "@prisma/schema-files-loader-6.8.2" = {
      ...
      version = "6.8.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.8.2.tgz";
        sha512 = "JRXJ08xfA1cP30kgP15AMCOKZchy2ss2oN6nSHxN745euh2tijpzvW4yCD4Q/1ZtnDkfKae45Tcpx0Ytab7RPA==";
      };
    };
    "@prisma/schema-files-loader-6.9.0-dev.33" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.9.0-dev.33";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.9.0-dev.33.tgz";
        sha512 = "y1hBWkmMK1Y39E7IcHtk3NWJgo+Xxnp4EPuk6t6i76fe4U9YyZSTObbmYh76mXDx7WMisAORPhDzSLkNOrFvNw==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.8.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.8.2.tgz";
      sha512 = "qJTyWvEW8iXXxCAoKqG5T4O55yY/odoojsRILvpnOV6zTv/UltIGRhvUjikkrh3nkLyrrbyiFjciec/zILBSIA==";
    };
    dependencies = [
      sources."@prisma/config-6.8.2"
      sources."@prisma/prisma-schema-wasm-6.8.0-43.2060c79ba17c6bb9f5823312b6f6b7f4a845738e"
      sources."@prisma/schema-files-loader-6.8.2"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7603";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7603.tgz";
      sha512 = "448Rm4YngFuG7XYBk4e/4IxPkPHT07huPun9wtZBvKVRMd5ndIftPlhQ57kGajlj3q8ye4bevqUl3N27uJ8RXQ==";
    };
    dependencies = [
      sources."@prisma/config-6.9.0-dev.33"
      sources."@prisma/prisma-schema-wasm-6.8.0-43.2060c79ba17c6bb9f5823312b6f6b7f4a845738e"
      (sources."@prisma/schema-files-loader-6.9.0-dev.33" // {
        dependencies = [
          sources."@prisma/prisma-schema-wasm-6.8.0-44.f31fc955f15addd30e95835648a3613d9068c631"
        ];
      })
      sources."@types/js-levenshtein-1.1.3"
      sources."fs-extra-11.3.0"
