  ...
  sources = {
    ...
    "@babel/core-7.22.7" = {
      ...
      src = fetchurl {
        ...
        sha512 = "exABdCVjEk8+IFJW0gOK6+cou8VKMXfbkLGeK5Xdsa5MsuQmem1SsnnZ+6avm2gRhZ4M7UgAnE6YoAzVg9P/pw==";
      };
    };
    ...
    "@babel/traverse-7.22.7" = {
      ...
      version = "7.22.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@babel/traverse/-/traverse-7.22.7.tgz";
        sha512 = "vQn61YQzktf1wFNzCka2dynnnbmBpUDeUCds3Y+FBHZpcVxpBq0XscQGDDVN7sV2Vf1pZDY1HmPR3U/5t7VfMQ==";
      };
    };
    "@babel/types-7.22.5" = {
    ...
    "caniuse-lite-1.0.30001512" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001512.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001512"
      sources."chalk-2.4.2"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2400";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2400.tgz";
      sha512 = "3AsgLGP/2bSNkj6MJ9dwqd1W45vJvie7aW3TiOhPGZmk+ZhXb4G5wJ82FmVivMpHBv/r4KbP+4Uq6qzYC0+K1Q==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
