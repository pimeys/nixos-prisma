...
let
  sources = {
    ...
    "@prisma/config-6.13.0-dev.1" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.13.0-dev.1.tgz";
        sha512 = "VyySAcR32iGpZen9OZ04EMlpGLE8EypUqzj6ELi9ZCPfbEBd1OwYABXXQllZOOzW/q/Ay8zbEBX1n4/SALIyjQ==";
      };
    };
    ...
    "@prisma/schema-files-loader-6.13.0-dev.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.13.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.13.0-dev.1.tgz";
        sha512 = "PjbwGkyfYxegt4nG9sXWwARpKUDElWRUljUjusEXKs9cX7XlgjmL0QAMeasnkSbDdduuXomQS04GR4uzByecGw==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7757";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7757.tgz";
      sha512 = "V5ZrZAWFBRPdq03eu/l+ZN28k8Gb5XI2FcTUnk/MgcDXw8KtVdosSXfcf+TzN5QtDybXz9nvN/pPGhMuTEU/Pg==";
    };
    dependencies = [
      sources."@prisma/config-6.13.0-dev.1"
      sources."@prisma/prisma-schema-wasm-6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc"
      sources."@prisma/schema-files-loader-6.13.0-dev.1"
      sources."@types/js-levenshtein-1.1.3"
      sources."fs-extra-11.3.0"
      sources."graceful-fs-4.2.11"
      sources."jiti-2.4.2"
