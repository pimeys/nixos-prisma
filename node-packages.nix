...
let
  sources = {
    ...
    "@prisma/config-7.8.0-dev.9" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.8.0-dev.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.8.0-dev.9.tgz";
        sha512 = "wDvWBSlHeyBMbCDaIr7QxRFFHJKPF5EN4B1XiVR4ulEhEPGlV/3bglVO6TOtDxphsjYnn93t5cOiYy0NEAQRkg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.8.0-dev.9" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.8.0-dev.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.8.0-dev.9.tgz";
        sha512 = "1Lh9xGswYWIBgO6YMPXsySSq5BkuaD7WfIqXvwetQsXPKz0sLahdrmXMcWyNCe1+QWlulaSvfs7ZHeuxtH43zA==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.9.9";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.9.9.tgz";
      sha512 = "0XFlBgFhIZSWu4xXQV9sQ/vouJrE/njb5zzEHiF4hG1ESO9PSGEawr8Guvvl91+HMFekv7veR2FDmPZjWMdtgw==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
