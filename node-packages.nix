...
let
  sources = {
    ...
    "@prisma/config-6.13.0-dev.6" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.13.0-dev.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.13.0-dev.6.tgz";
        sha512 = "EmnLwMjTkEYvTQcma4rF1zGOmGfsP0EhgAt7EZLVWGplI1fXAMa+YXuo3LPCZXBxf6boOBY7D+MndSdg+Pg1Cw==";
      };
    };
    ...
    "@prisma/schema-files-loader-6.13.0-dev.6" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.13.0-dev.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.13.0-dev.6.tgz";
        sha512 = "D1I9JpWUX33MZS+DSX0XxRlk/vSxVyfIk0EA+hgB2SKV0kR6nqDjdHlwHmnJIpcS5P9sC4Uw4gt2T/r7QYIFmw==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7762";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7762.tgz";
      sha512 = "/pqWGDm1hQTYgmIFk8WXOEremrSJrOrjw5V3WaVhsFtoVKCnuCuBbo48MQXd41ZPd02VtAWrGj3CpxkBZwPR+g==";
    };
    dependencies = [
      sources."@prisma/config-6.13.0-dev.6"
      sources."@prisma/prisma-schema-wasm-6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc"
      sources."@prisma/schema-files-loader-6.13.0-dev.6"
      sources."@types/js-levenshtein-1.1.3"
      sources."fs-extra-11.3.0"
      sources."graceful-fs-4.2.11"
      sources."jiti-2.4.2"
