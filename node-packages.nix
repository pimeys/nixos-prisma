...
let
  sources = {
    ...
    "@prisma/config-6.17.1" = {
      ...
      version = "6.17.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.17.1.tgz";
        sha512 = "fs8wY6DsvOCzuiyWVckrVs1LOcbY4LZNz8ki4uUIQ28jCCzojTGqdLhN2Jl5lDnC1yI8/gNIKpsWDM8pLhOdwA==";
      };
    };
    "@prisma/config-6.18.0-dev.21" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.18.0-dev.21";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.18.0-dev.21.tgz";
        sha512 = "JLdnph/iLMJo7b/C7xctdDfEsFlokHZlYd9jOTjXfYP4zocDCIXDHfsFVOGgoqLmG965tmEkBVEzOJWTiCt8aA==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.17.1-1.272a37d34178c2894197e17273bf937f25acdeac" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.17.1-1.272a37d34178c2894197e17273bf937f25acdeac.tgz";
        sha512 = "lSeL/eOjCt7SauvAhvlzbYL6fbkBBC07tdghT7dwhRHEorfYh2TTVQQwN29BJgNFufYEyFLYMIoYRHSw4InphQ==";
      };
    };
    "@prisma/prisma-schema-wasm-6.18.0-7.d3fc122f88ca3ce86f67a797debfb179a39ccf48" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.18.0-7.d3fc122f88ca3ce86f67a797debfb179a39ccf48";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.18.0-7.d3fc122f88ca3ce86f67a797debfb179a39ccf48.tgz";
        sha512 = "dPPMTvAy9t+mGm9A6RLQrDz7MrB417dji3wNBE3QETo6vAJKhHvAYVxB0JI1At5gPzkW3cjGslvLGcTZlKL5jA==";
      };
    };
    "@prisma/schema-files-loader-6.17.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.17.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.17.1.tgz";
        sha512 = "rRYUP664wFbdvqSbqKdNijb2LHP6A3yEauPy4V7WJDR9ySQJ8adV0nP0cBcUAzHAsBW1JVMwqF+OKIrcwVG3qg==";
      };
    };
    "@prisma/schema-files-loader-6.18.0-dev.21" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.18.0-dev.21";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.18.0-dev.21.tgz";
        sha512 = "0UzYvWFaQd1uV1zdqkjpkubiskgwno5KbVj88OGxzBjDbitD/JFsxNN1Il0uPnAe2k6zx/3qdyGuxLtM+lmNcA==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.17.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.17.1.tgz";
      sha512 = "nGsYmaEIaB3mBmK55nTAeMSOuy6CIyetERibcZ/iErrWBWwd1PkG1IYs7WbPK1Jwr+dcUlb+5i92kTieN/i9mA==";
    };
    dependencies = [
      ...
      sources."@prisma/config-6.17.1"
      sources."@prisma/prisma-schema-wasm-6.17.1-1.272a37d34178c2894197e17273bf937f25acdeac"
      sources."@prisma/schema-files-loader-6.17.1"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7956";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7956.tgz";
      sha512 = "2hp7azEQAU/lfg/QfLojX5a/DA/fqk/mHw2GYXUJjN1VwC6VkZScH8+CJF+1ei1dl/eBmAJoddWPeGU+Vkzdqw==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.27.1"
      sources."@babel/parser-7.28.4"
      sources."@babel/types-7.28.4"
      sources."@prisma/config-6.18.0-dev.21"
      sources."@prisma/prisma-schema-wasm-6.18.0-7.d3fc122f88ca3ce86f67a797debfb179a39ccf48"
      sources."@prisma/schema-files-loader-6.18.0-dev.21"
      sources."@standard-schema/spec-1.0.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
