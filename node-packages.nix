...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.891";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.891.tgz";
      sha512 = "dTXSpkZg3gQlVKFf3ujfe5NfqFa9EeYMVWCYTpWUhG6T/MrDqVHCPYIdoxLgfnDdC7OBoQPby9E40EF0KRblug==";
    };
    dependencies = [
