...
let
  sources = {
    ...
    "electron-to-chromium-1.4.753" = {
      ...
      version = "1.4.753";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.753.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.753"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3585";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3585.tgz";
      sha512 = "bzcpowemVZ8WLadildm5WTvRy7nRvb2L2+Jm39L1LtsRE/TdOkUJKgpJiKWBhoSs88tkRKoiODzflh3RKPq09Q==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.2"
