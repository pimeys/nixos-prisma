...
let
  sources = {
    ...
    "@prisma/config-7.7.0-dev.2" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.7.0-dev.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.7.0-dev.2.tgz";
        sha512 = "3zmuMGEpZ8gUyA7MhdMpqdEf1QwwdSNe1GK1YRCJXG5mK1eJcHG02FhyPONVzlPcHafBhzUIxkUKihVELcWG7g==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.7.0-dev.2" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.7.0-dev.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.7.0-dev.2.tgz";
        sha512 = "rlFpM03Z0Eao4DVTkheWbJmfOSNfqBG1YNWfHtQ6f8Hu2JMxrsIGtg1Yxi/H4BEdLmD5L2lCNNHSWGMKTRXFLA==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "31.8.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.8.0.tgz";
      sha512 = "5ScZPtSD7lLLxTIGz5VwEx9ODYBXplKZss0ZnE6agE8YUSVViUHQbbes71vP8ARM2hxaMdhYQ6fISu523oMM4Q==";
    };
    dependencies = [
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.7.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.7.3.tgz";
      sha512 = "X7tuwUQaXCtR1K5l1c0rTNI6+qB2AFzgW3cahY4uEu1GIavw9baNmaf1b8rP9X2m3WGQh+98uW1zXUElWd7kUg==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.7.0-dev.2"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.7.0-dev.2"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
