...
let
  sources = {
    ...
    "electron-to-chromium-1.4.205" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.205";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.205.tgz";
        sha512 = "sSHlbfqn6CgQqD9muogEwWrw1wi2tHEQ+sunW7ex/kJ9ICucE85JW0E9ekbRDDgLP7NlpoNVUl+el0556RhFIg==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1238";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1238.tgz";
      sha512 = "U8vawCSe8DzfYcIJAhx3O4zhfHDzVqelJwdU7mwlxZJXA1DOsi/pqPZwbCqgevi8L+l7xNNGKhA+tDbCRG9h6g==";
    };
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.205"
