...
let
  sources = {
    ...
    "electron-to-chromium-1.4.262" = {
      ...
      version = "1.4.262";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.262.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.262"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1437";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1437.tgz";
      sha512 = "gMH0lI2eiEF/OaLu7ZXixPHwH1sYh0xc+BgyCmss0mqcHlm55FXccfrqB2o/3rhb1hvMQX1BYyakENFEvZ9tGg==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
