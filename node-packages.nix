...
let
  sources = {
    ...
    "@prisma/config-7.7.0-dev.1" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.7.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.7.0-dev.1.tgz";
        sha512 = "MUyaub+nb1qLEGYLtBHyumo9+y5CVDY+rirU9xKB1We0gdqsjR9AiC8y+SJP+Pgg/NYN5TEv9nmBPvcie9HS2w==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.7.0-dev.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.7.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.7.0-dev.1.tgz";
        sha512 = "cxAxN9mswtSqtXRRr6gwwX5v9ljTFF9pqA7FhRdo9itesaZsbbAdGOEhlCgmk2AmpNIG0S5Lg8OapxTwXXYgMA==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.7.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.7.2.tgz";
      sha512 = "YoGqoZSor1UsvY8z69Wid0MNYosGdIkoe3wwLX4UGXFrbh400VR0Ql3CtZ9s9XHnyVfwKG8tLHa5ejLTZoAQ4w==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.7.0-dev.1"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.7.0-dev.1"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
