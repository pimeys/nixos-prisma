...
let
  sources = {
    ...
    "@prisma/config-6.17.0" = {
      ...
      version = "6.17.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.17.0.tgz";
        sha512 = "k8tuChKpkO/Vj7ZEzaQMNflNGbaW4X0r8+PC+W2JaqVRdiS2+ORSv1SrDwNxsb8YyzIQJucXqLGZbgxD97ZhsQ==";
      };
    };
    "@prisma/config-6.18.0-dev.5" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.18.0-dev.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.18.0-dev.5.tgz";
        sha512 = "PhAWjpKLHo1zhWqci/ZUfGuEN3FiW4SB89fzrwq+O8LGzz9gf7+BPJ+aMCwh6kF4GwJQ25ssYwf/PozSeXWpvA==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.17.0-16.c0aafc03b8ef6cdced8654b9a817999e02457d6a" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.17.0-16.c0aafc03b8ef6cdced8654b9a817999e02457d6a.tgz";
        sha512 = "rQWyWSMBvWloIw+GB/iCtv7FV4Kh/ZVefFDuqBiFRSSCIExImRbWy4gg0Rm3bjK40Kp39Umn2S/DFySI/7x65A==";
      };
    };
    "@prisma/prisma-schema-wasm-6.18.0-1.a3a68297617862dfc64e9773802511b304419ce4" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.18.0-1.a3a68297617862dfc64e9773802511b304419ce4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.18.0-1.a3a68297617862dfc64e9773802511b304419ce4.tgz";
        sha512 = "PMDmQLUINQ+lcvraj9QEqACAjxPpMH/0LdcuSCPyQRKTSwxfBQBWNB7eg6kwe7/gNpYQJNC03j4RQbwYU8ZvIA==";
      };
    };
    "@prisma/schema-files-loader-6.17.0" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.17.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.17.0.tgz";
        sha512 = "zzqI+GyugMncIhEtTuYVMSrEUdzAt4231VlxcmVoS0WFrfCd09lWjtpZOZrDU0TP4uSIABEsWIiJ1RR7bzE2Cw==";
      };
    };
    "@prisma/schema-files-loader-6.18.0-dev.5" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.18.0-dev.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.18.0-dev.5.tgz";
        sha512 = "mKKeHGK4AXW+DIpjTBL4uaVGQlLODOS0IZlNRowCk40i0+JcmzhL8wZUoRmvCoMxuj3n5KZ7vziIT77+l8Pewg==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.17.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.17.0.tgz";
      sha512 = "N+IxqfzFC8ST5PDJukaGsI2jj7NQOIvXQJbjxmjM3lsZypH7arvBx9mcyrJCr+0kapqBcaxO/Z0ylICTuBatSw==";
    };
    dependencies = [
      ...
      sources."@prisma/config-6.17.0"
      sources."@prisma/prisma-schema-wasm-6.17.0-16.c0aafc03b8ef6cdced8654b9a817999e02457d6a"
      sources."@prisma/schema-files-loader-6.17.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7941";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7941.tgz";
      sha512 = "TISQ0AQ8aqrUZVfaXbrBGYxvoFQe/BYaXzsf9wAI46ZlOPN+5kSUth0z78XkEumdpi0Tds/1+ReoZLIZ8jKp7g==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.27.1"
      sources."@babel/parser-7.28.4"
      sources."@babel/types-7.28.4"
      sources."@prisma/config-6.18.0-dev.5"
      sources."@prisma/prisma-schema-wasm-6.18.0-1.a3a68297617862dfc64e9773802511b304419ce4"
      sources."@prisma/schema-files-loader-6.18.0-dev.5"
      sources."@standard-schema/spec-1.0.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
