...
let
  sources = {
    ...
    "@prisma/prisma-schema-wasm-5.20.0-12.06fc58a368dc7be9fbbbe894adf8d445d208c284" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.20.0-12.06fc58a368dc7be9fbbbe894adf8d445d208c284.tgz";
        sha512 = "tE5ZxPwI381Mrzgd1/GLJFusD1SfVXGzOWRU2P9c9zk25nlfa6GkyaqCtSTIaINexPAAy4npsCoAFt2Hc4rqYQ==";
      };
    };
    "@prisma/prisma-schema-wasm-5.21.0-33.edd552ca6fe6bb4ebbfe57bafc00a55aef8e10dd" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "5.21.0-33.edd552ca6fe6bb4ebbfe57bafc00a55aef8e10dd";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.21.0-33.edd552ca6fe6bb4ebbfe57bafc00a55aef8e10dd.tgz";
        sha512 = "lw+VQSfVayp4kjzVaGP0lqQoRAEDZ9uN3+S2Fbc+mi3X/q9Utfy1VeHkY5VH3zrpiFStj4n450UHX8jPWseydg==";
      };
    };
    "@prisma/schema-files-loader-5.20.0" = {
      ...
      version = "5.20.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.20.0.tgz";
        sha512 = "Mq4an/vxzdjL+e1GZIw93xTDaU6Gq+2RMuW6NEs+XHAhmiOaBrw9QARZhc+QURY3wwAdj2dUSpoy4xaWON9JTg==";
      };
    };
    "@prisma/schema-files-loader-5.21.0-dev.9" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "5.21.0-dev.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.21.0-dev.9.tgz";
        sha512 = "t2mVC7gvpFVUhKyCn6J6v9X+0sajVN0FYkFZNOqkdk/Z52uz9CcgYFq2Er4Pm/6UrGEqLoiy1pv52QEr2XhVDA==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "5.20.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-5.20.0.tgz";
      sha512 = "jHqIaRa8FyqDo1aQFMlE1LLCOHT3fUdQH4vAkWjtXJYeNt9cJDaS1BeW257baFmVeCzm4aowTdvIpg9kybIDXA==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.20.0-12.06fc58a368dc7be9fbbbe894adf8d445d208c284"
      sources."@prisma/schema-files-loader-5.20.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7056";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7056.tgz";
      sha512 = "XwH1V12wbi77vMVK6WV/he9ppu3ujTLOBuIJ+gneCvoL/dF5kE2U1/2AFV9okmyClED0Jm/2lz1lXGrexr1L4Q==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.21.0-33.edd552ca6fe6bb4ebbfe57bafc00a55aef8e10dd"
      sources."@prisma/schema-files-loader-5.21.0-dev.9"
      sources."@types/js-levenshtein-1.1.3"
      sources."fs-extra-11.1.1"
      sources."graceful-fs-4.2.11"
      sources."js-levenshtein-1.1.6"
