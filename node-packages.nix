...
let
  sources = {
    ...
    "@prisma/config-7.4.0" = {
      ...
      version = "7.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.4.0.tgz";
        sha512 = "EnNrZMwZ9+O6UlG+YO9SP3VhVw4zwMahDRzQm3r0DQn9KeU5NwzmaDAY+BzACrgmaU71Id1/0FtWIDdl7xQp9g==";
      };
    };
    "@prisma/config-7.5.0-dev.11" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.5.0-dev.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.5.0-dev.11.tgz";
        sha512 = "ZWgPZkiPP1BSJYFi/sjO4o+niClSzdUsE3N65GTyG24M8nK42fLcCS0iFDTmBQfcshoL4zKoeTRF0fz5wnBE8A==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-7.4.0-20.ab56fe763f921d033a6c195e7ddeb3e255bdbb57" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-7.4.0-20.ab56fe763f921d033a6c195e7ddeb3e255bdbb57.tgz";
        sha512 = "c4l8sQorhTZGIRx2IcJZUoFBaST0jVhbKb7yC68FF065T11K5BNAQt8mgcsdsC2UA1AsRK1LFpMZjvfiYg1tNA==";
      };
    };
    "@prisma/prisma-schema-wasm-7.5.0-3.3f492635eb3e6b8b8cdfeb170b6c4f7e31f2f303" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "7.5.0-3.3f492635eb3e6b8b8cdfeb170b6c4f7e31f2f303";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-7.5.0-3.3f492635eb3e6b8b8cdfeb170b6c4f7e31f2f303.tgz";
        sha512 = "26lEqGz7B1ljzjFv8BDerFqmbE/AZ7qczF7c4oeVY+5w8UA7O+ujzB47t4TyxqLA3HPp2C3fYodMcqW3ylrLIg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.4.0" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.4.0.tgz";
        sha512 = "cAIT4ES7EzeCac/9CeM1Bsxtk6HWEKOc85DCIHNI0B8+qFux0uwUI93RBYDRS4BfmnTvwG9CRHUAVRrDFRROJg==";
      };
    };
    "@prisma/schema-files-loader-7.5.0-dev.11" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.5.0-dev.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.5.0-dev.11.tgz";
        sha512 = "wk5OSgoiZ+CK23L2Zq0k6xSnAFKswiDZMAaUF5jRv9VtYNVi/++LMOOhWG7icZtYMXWMs+mkcPz42Swi+tTNuA==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "31.5.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.5.0.tgz";
      sha512 = "lSNcwkj6lu+sfmmumUTZsK51u5hCRFqSrB3tmzEGkBt79XRb948uqbilNjScb/L/9RIwVm2RJrN+akKh6T78Rg==";
    };
    dependencies = [
      ...
      sources."@prisma/config-7.4.0"
      sources."@prisma/prisma-schema-wasm-7.4.0-20.ab56fe763f921d033a6c195e7ddeb3e255bdbb57"
      sources."@prisma/schema-files-loader-7.4.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.5.10";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.5.10.tgz";
      sha512 = "pxsH52Yj2BA3SICSM4sMrlcxjTY4LD3QyPwF1iPwcjmujeNG6gBdCBcDPlg8ALV9j4FqUvSN795HRmShbXNBAQ==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.0"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.5.0-dev.11"
      sources."@prisma/prisma-schema-wasm-7.5.0-3.3f492635eb3e6b8b8cdfeb170b6c4f7e31f2f303"
      sources."@prisma/schema-files-loader-7.5.0-dev.11"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
