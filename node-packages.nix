...
let
  sources = {
    ...
    "electron-to-chromium-1.4.760" = {
      ...
      version = "1.4.760";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.760.tgz";
        sha512 = "xF6AWMVM/QGQseTPgXjUewfNjCW2fgUcV/z5cSG0r+SiYcgtvcmRAL3oH/MSZwHBBD+fyKTXdQ4qGENJMSedEQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.760"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3617";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3617.tgz";
      sha512 = "NqJpHGSFIMRW+e5Ysa4sXRPsAh9p9OGhEhxemoiNsGyUCnlssBYrYSCZV+rQEQyuO+VByqFLPHhAINc0MV6mxg==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.2"
