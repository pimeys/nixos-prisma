...
let
  sources = {
    ...
    "electron-to-chromium-1.4.726" = {
      ...
      version = "1.4.726";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.726.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.726"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3514";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3514.tgz";
      sha512 = "aYSyo5Fv9ds+OykEvkDwlFYL/Xd5NXvel7j/iOMWU5AqI3rDqPUMkmG2qhHJmN7TGQXpa37r414/fVpvohkh/Q==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.2"
