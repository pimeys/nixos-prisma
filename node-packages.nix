...
let
  sources = {
    ...
    "@prisma/config-7.8.0-dev.1" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.8.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.8.0-dev.1.tgz";
        sha512 = "B2FkcyHzlDJHR11M/HtBoAlDrwHUvNVV9F5wt4BObrBtYjAnfzgr3zgXkx3J1cXDdIhzm0WFaUAWc44oOnffmg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.8.0-dev.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.8.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.8.0-dev.1.tgz";
        sha512 = "DIA/mUsKuH+PHbnrFSYWiemye7cCh2OT1TFkRAUfJ2KhbRkDcfI7lKdRDPAUVcNwX+qvpYzd5yMyPnJbg+YziA==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.9.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.9.1.tgz";
      sha512 = "GXkZDll2XVdYCchye5C7fHXVlU8EPz1/AJ6qnrkhuxbCVYDyZB4TQgnQk7YGzZK4BXJzvkkRfsq7xHqDi76qUg==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.8.0-dev.1"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.8.0-dev.1"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
