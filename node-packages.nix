...
let
  sources = {
    ...
    "@prisma/prisma-schema-wasm-5.15.0-7.0af42cb19116c37b029e1f3665681074acb38bb4" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "5.15.0-7.0af42cb19116c37b029e1f3665681074acb38bb4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.15.0-7.0af42cb19116c37b029e1f3665681074acb38bb4.tgz";
        sha512 = "HG4+qQHNo9a3JFf801jEkvruKpB2HjQbR8yKgd4vGluevOIOzNMEmLAXxx5V3JpyyHZxsTFQdz4XakqBdJIIug==";
      };
    };
    "@prisma/schema-files-loader-5.15.0-dev.30" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "5.15.0-dev.30";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.15.0-dev.30.tgz";
        sha512 = "BxRylEqLUoAywBckaQTuQ1vOiPFxQ/Mqs0FQVpTL8W16omS3G2vI9Gh5IFmVrNC9vavWbw4MHJu2jlDEVhWtSA==";
      };
    };
    ...
    "caniuse-lite-1.0.30001622" = {
      name = "caniuse-lite";
      packageName = "caniuse-lite";
      version = "1.0.30001622";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001622.tgz";
        sha512 = "H+g7cwL2r1TzN4HpM1ZzhaOf7zwMNAZomX/uao6flMFsT3sLIpxi9H3QMo7U0KPWr0a8/Zvl8sQgrr6RXJ0HRw==";
      };
    };
    "chalk-2.4.2" = {
      name = "chalk";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001622"
      sources."chalk-2.4.2"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3666";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3666.tgz";
      sha512 = "cQ1Cfs7NJE8PJBCqPjmd24BQhCSZsL5um/r39xJS8VJF02c+TbNllXy9s6kPcdt1pJt1C3mXfbprL52YtxiLkg==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.15.0-7.0af42cb19116c37b029e1f3665681074acb38bb4"
      sources."@prisma/schema-files-loader-5.15.0-dev.30"
      sources."@types/js-levenshtein-1.1.3"
