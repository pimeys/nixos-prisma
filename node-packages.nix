...
let
  sources = {
    ...
    "@prisma/config-7.7.0-dev.5" = {
      ...
      version = "7.7.0-dev.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.7.0-dev.5.tgz";
        sha512 = "/cgaPWLEOyNKl8cI2MFbFuv52pPzBWuQ/VGkeuuoGY3A8sfwVcUO1pwd4UNO5JDEI28zHocSMq0RsGgC4T93Sg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.7.0-dev.5" = {
      ...
      version = "7.7.0-dev.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.7.0-dev.5.tgz";
        sha512 = "cRpEq5XW6h5GxaYVxdAuNiC/iyoUdbvPMBmR75MyCd1kZLqTjXUX0hjInP6iltyvL5VSh3L/I6+t22gt+O7IIQ==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.8.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.8.3.tgz";
      sha512 = "MAFpjrEjiXnBYcwT1DrP2SDXtRBta5JQ+hkQ4jA6p6njRTjBYLuafrQwNM2U+wMzCYGzaWCNib8LUmyfwws5bw==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.7.0-dev.5"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.7.0-dev.5"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
