...
let
  sources = {
    ...
    "@prisma/config-6.16.3" = {
      ...
      version = "6.16.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.16.3.tgz";
        sha512 = "VlsLnG4oOuKGGMToEeVaRhoTBZu5H3q51jTQXb/diRags3WV0+BQK5MolJTtP6G7COlzoXmWeS11rNBtvg+qFQ==";
      };
    };
    "@prisma/config-6.17.0-dev.28" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.17.0-dev.28";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.17.0-dev.28.tgz";
        sha512 = "pw4C7btvEMexxwsM0Ueu8Rk3o9YAXG1vNuRALJHpg+kr4z6IumBno8gb5WvGCBbBWcbgVmrZEMNKdg06qVO6VA==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a.tgz";
        sha512 = "Le8rlsY6CxuQpuFWcY4S0GM6SBHvwpZFXWHwPdaCibxgKX2WfnYFST6PJmNDpNV1/TAa1YLLyXtE3ZlKywBQnw==";
      };
    };
    "@prisma/prisma-schema-wasm-6.17.0-12.c93d14b2da5fb8aabcb60751cd0e29de11bea73c" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.17.0-12.c93d14b2da5fb8aabcb60751cd0e29de11bea73c";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.17.0-12.c93d14b2da5fb8aabcb60751cd0e29de11bea73c.tgz";
        sha512 = "ynXcdItO1bCRUeO9iLqSnRSvctveQ47iyQ7i0XfQun6HRIlMcVPR9wGSU38i+1FoOxxcpc7o4MJPNrjS8+EtmA==";
      };
    };
    "@prisma/schema-files-loader-6.16.3" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.16.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.16.3.tgz";
        sha512 = "Rvw2ZVMBaUyfHWjHCYKDacI4IgtuOuj8amFd1wFwrBIEkiCbIX1nMo6xafKpmKFcDVx0io01k/LuL/PycKI5TA==";
      };
    };
    "@prisma/schema-files-loader-6.17.0-dev.28" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.17.0-dev.28";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.17.0-dev.28.tgz";
        sha512 = "3sy7vcunb9jBRZ/VTjVntxye9QDzyAqKFWK+sw4bpQ6xHqwoQOIwxgFMLLizZxdAn8V9ZxFD5T8f/sHChk5usA==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.16.3";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.16.3.tgz";
      sha512 = "NyVGWbMK+h8Lr61JOOk4EsrBarYJr683v7vSU8xk8pFehPxl1Y8nfaVsJKV8hDewALud2SHhGzfjmvc7HLHwgQ==";
    };
    dependencies = [
      ...
      sources."@prisma/config-6.16.3"
      sources."@prisma/prisma-schema-wasm-6.16.1-1.bb420e667c1820a8c05a38023385f6cc7ef8e83a"
      sources."@prisma/schema-files-loader-6.16.3"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7930";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7930.tgz";
      sha512 = "gOwXHnZOjtqSOajV4teSHpzddHhuVTjWKpN6lnUJkEx/1R6U32fKWYoj1nNH4KO4TNuwfmyqA89WTADmMyJGNQ==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.27.1"
      sources."@babel/parser-7.28.4"
      sources."@babel/types-7.28.4"
      sources."@prisma/config-6.17.0-dev.28"
      sources."@prisma/prisma-schema-wasm-6.17.0-12.c93d14b2da5fb8aabcb60751cd0e29de11bea73c"
      sources."@prisma/schema-files-loader-6.17.0-dev.28"
      sources."@standard-schema/spec-1.0.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
