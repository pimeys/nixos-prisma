...
let
  sources = {
    ...
    "electron-to-chromium-1.4.344" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.344";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.344.tgz";
        sha512 = "m4HjHLGMPJddM0FZmPxZkk6whzeqK/B3zkzAB7KAopv2TkePzXQcM8aOfDS+1NOjD44lgA89yHRkNAQ/5uCQXQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.344"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2030";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2030.tgz";
      sha512 = "OJczQ3CJ4yEWmqJZhR9b2C9GIiXVssUelbzgP4SAWgvT/A1fjJMDhahf60/0xSe7JMxU6JN2tce3IVNFiKE0xQ==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
