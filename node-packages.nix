...
let
  sources = {
    ...
    "electron-to-chromium-1.4.479" = {
      ...
      version = "1.4.479";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.479.tgz";
        sha512 = "ABv1nHMIR8I5n3O3Een0gr6i0mfM+YcTZqjHy3pAYaOjgFG+BMquuKrSyfYf5CbEkLr9uM05RA3pOk4udNB/aQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.479"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2546";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2546.tgz";
      sha512 = "y428e6vBfwxSrtbcec/n+qFPH9KDgSeHljsgo8gWCLP8+tB22H+PfZ2XJKGtTRNHCoqZIAK7X4uP6uSgebIOFw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
