...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.5147";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.5147.tgz";
      sha512 = "OOSdLMNDpABADcxxfZT0Il06AMjzEfMckeFx4VPEMCyIOuZJlOY8mJc9JMpiUFwtK1ZT+uFSIVtw3i4kETzJ/Q==";
    };
    dependencies = [
