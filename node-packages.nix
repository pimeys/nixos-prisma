...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.4549";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.4549.tgz";
      sha512 = "TK4ZfGJZAQWRpXgrlkDIlPbe/5/3l7zZaDkZV+CxTXcQoScOfMHOFYOMdJeU6PHwq08MCkwMdTw1uMbPFGvu6w==";
    };
    dependencies = [
