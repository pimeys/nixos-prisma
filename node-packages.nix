...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.666";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.666.tgz";
      sha512 = "dV+lpQpS8DUrPRGGXXMsPtMVWcHtNPLYmiYougFJLFOZz2Aa7j0lGhzl8r7kpYmRq/gAvN47z2mG8xmbSaWnog==";
    };
    dependencies = [
