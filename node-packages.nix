...
let
  sources = {
    ...
    "electron-to-chromium-1.4.276" = {
      ...
      version = "1.4.276";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.276.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.276"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1480";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1480.tgz";
      sha512 = "VoNMiittqinjVbK1GkWTwruMjIT5CSmKH4yxJEBHfMtvdP0Hf5/4p9Jq+49Cm3l/ZfMcfxkiv1D3bk/m1PA+jg==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
