...
let
  sources = {
    ...
    "@prisma/config-6.13.0-dev.31" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.13.0-dev.31.tgz";
        sha512 = "TCUe3a45K0r3+KTXU7EKDhR0iIC90coRJXod6Ok/wnhjVg2Yf4ZIbp3r2kDmEIqdqyzWInxt/I9mbPIc7ZdyNw==";
      };
    };
    ...
    "@prisma/schema-files-loader-6.13.0-dev.31" = {
      ...
      version = "6.13.0-dev.31";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.13.0-dev.31.tgz";
        sha512 = "x8rPKCDptAUjx54+O824eiujeI7fK/4+y2VmiEVh0HRKKYNpPUhNDCu5Z9jtoH+zGjrMI8DZWBdhi5JG+s4lOA==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7789";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7789.tgz";
      sha512 = "zSGXsvXq3RJsv4iDqVEtIueAgjMfXcPt1ELVfl59isFjRGB6FrRuuHDbjAL5MvioywCei4gX7rOS6kyLIkKl0w==";
    };
    dependencies = [
