...
let
  sources = {
    ...
    "electron-to-chromium-1.4.365" = {
      ...
      version = "1.4.365";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.365.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.365"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2063";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2063.tgz";
      sha512 = "3rX3tVATcFLCJyj8fqaN+ZRhYjexsQwXL3RYS/XVdVXWJLu6N+ROZ6LnnogNueWPj4extE8d79U+i5gELgvh+A==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.21.4"
