...
let
  sources = {
    ...
    "@prisma/config-6.14.0" = {
      ...
      version = "6.14.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.14.0.tgz";
        sha512 = "IwC7o5KNNGhmblLs23swnfBjADkacBb7wvyDXUWLwuvUQciKJZqyecU0jw0d7JRkswrj+XTL8fdr0y2/VerKQQ==";
      };
    };
    "@prisma/config-6.15.0-dev.7" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.15.0-dev.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.15.0-dev.7.tgz";
        sha512 = "I2jmbPGhy7ihQVWXXlidnhFzJ0C3EQRfvalOU5nSlM4uJ52NT7iWJjHQqo/m7MYCAnoQTAaFwHQKR8FfBOSRXg==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.14.0-25.717184b7b35ea05dfa71a3236b7af656013e1e49" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.14.0-25.717184b7b35ea05dfa71a3236b7af656013e1e49.tgz";
        sha512 = "yvwBbuiMDAi9xnihGvwnrK8m8l3ikNxoEyUzTXgNtfteGm7C9KDYvuLJV3jUixckNlSAk4pFhBcfhxHYUM7u2A==";
      };
    };
    "@prisma/prisma-schema-wasm-6.15.0-1.4d84597d45f23a11ea7673dd0d603d8aaa4a86b7" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.15.0-1.4d84597d45f23a11ea7673dd0d603d8aaa4a86b7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.15.0-1.4d84597d45f23a11ea7673dd0d603d8aaa4a86b7.tgz";
        sha512 = "sg0lOk2xFI58CvQkbCGDG3pZsjb3I6vosYcYgyZC1Nh3CRNGlBNtasStNAs0rfZVRE/GgPBHfyIqdSJWTOKI2Q==";
      };
    };
    "@prisma/schema-files-loader-6.14.0" = {
      ...
      version = "6.14.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.14.0.tgz";
        sha512 = "i80AKova0e5hQRdDhloF7cCo9ydfZZsM230SmMq9hhw5KEckgldx/5g3Z885B98bCNYO6fh0VVsG1NgDG6pcdg==";
      };
    };
    "@prisma/schema-files-loader-6.15.0-dev.7" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.15.0-dev.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.15.0-dev.7.tgz";
        sha512 = "RA/hc+VcwQy5M0b5LHBQZanM9otkzwQmqUOFXC6wYPxr+r0nMkCi8eIicZdSJToe6588zdj4z+WCR75QuEqeXQ==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.14.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.14.0.tgz";
      sha512 = "nmmZv30W9rnbNow/o5JoVuePtjhWUxExDU9OCqVOBosGBQ0I4sp1cabkJdU+KSOX0k/CHzKtekglC7zD8eTvLA==";
    };
    dependencies = [
      ...
      sources."@prisma/config-6.14.0"
      sources."@prisma/prisma-schema-wasm-6.14.0-25.717184b7b35ea05dfa71a3236b7af656013e1e49"
      sources."@prisma/schema-files-loader-6.14.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7843";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7843.tgz";
      sha512 = "mPS3gFjW0r5J2IZQ4LbE10oqnL2yTZpg4yPOcgWao6my7Wscep0HYX7l9KnZ+uWSMJDo2hb0FD2pmYi07ddZJQ==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.27.1"
      sources."@babel/parser-7.28.3"
      sources."@babel/types-7.28.2"
      sources."@prisma/config-6.15.0-dev.7"
      sources."@prisma/prisma-schema-wasm-6.15.0-1.4d84597d45f23a11ea7673dd0d603d8aaa4a86b7"
      sources."@prisma/schema-files-loader-6.15.0-dev.7"
      sources."@standard-schema/spec-1.0.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
