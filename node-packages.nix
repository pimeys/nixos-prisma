...
let
  sources = {
    ...
    "electron-to-chromium-1.4.466" = {
      ...
      version = "1.4.466";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.466.tgz";
        sha512 = "TSkRvbXRXD8BwhcGlZXDsbI2lRoP8dvqR7LQnqQNk9KxXBc4tG8O+rTuXgTyIpEdiqSGKEBSqrxdqEntnjNncA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2486";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2486.tgz";
      sha512 = "NEHJ8HckFkvXRNXHLrrLJPFFMBhqddPBEzNlrQ0GalFrhdQpdyUujWU5SzWOjHCdJ3L8rozZD9/eAeXm41GtsQ==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
