...
let
  sources = {
    ...
    "@prisma/config-7.8.0-dev.10" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.8.0-dev.10.tgz";
        sha512 = "vEQIkhV1yxeUkWB1mEZDP/NGD0wQoFRtQxvI0qmb/VFJooB7gIzavdvAbdaSh0kvGmmXRpgPH4FnP/1ZIIHnuA==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.8.0-dev.10" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.8.0-dev.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.8.0-dev.10.tgz";
        sha512 = "ehiShcgbHKrpB1wbbkJrabvUPLK5aTH/VUog+DakuH6qtu4W3gV0BWC0qSZrRaKvon18wrVBi1NsuggaHYGvYQ==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.9.10";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.9.10.tgz";
      sha512 = "JYcmj3922OV6fiEg5VFsd//WERYLmaUlRQNE8pGmXLyQRQp0OQELpi6A57wVLKGoSHWIDNpCduV5mKn4qB/Jrw==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
