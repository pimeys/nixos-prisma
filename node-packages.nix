...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1273";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1273.tgz";
      sha512 = "GyF9fRxSO16zUimM0gfXekwms2OSkgrMbnpMysk6uFeu+6gOLkDeyClzQW7jiPqy1vPc0oxcJc17OaqIJryjJA==";
    };
    dependencies = [
