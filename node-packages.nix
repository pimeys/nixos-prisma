...
let
  sources = {
    ...
    "electron-to-chromium-1.4.387" = {
      ...
      version = "1.4.387";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.387.tgz";
        sha512 = "tutLf+alr1/0YqJwKPdstVvDLmxmLb5xNyDLNS0RZmenHcEYk9qKfpKDCVZEKJ00JVbnayJm1MZAbYhYDFpcOw==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.387"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2163";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2163.tgz";
      sha512 = "TYtpM7nUF6HarVGT/44fxCT2NuAyeEnPeH3NLUuwFGKHvi5xk/qk7E+3FuNHPvFm8pQRDSWLwSWWGXTU0/6L8Q==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.21.4"
