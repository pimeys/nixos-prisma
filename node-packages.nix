...
let
  sources = {
    ...
    "electron-to-chromium-1.4.265" = {
      ...
      version = "1.4.265";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.265.tgz";
        sha512 = "38KaYBNs0oCzWCpr6j7fY/W9vF0vSp4tKFIshQTgdZMhUpkxgotkQgjJP6iGMdmlsgMs3i0/Hkko4UXLTrkYVQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.265"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1462";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1462.tgz";
      sha512 = "sHbO7Z9nvfv+yVhA61quAtouPPLT0j1kSm22lqhSqiz5acMoC10vRLlFHFHG20fx5/I/q1CzkZNibftGZVvVCQ==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
