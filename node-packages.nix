...
let
  sources = {
    ...
    "electron-to-chromium-1.4.410" = {
      name = "electron-to-chromium";
      packageName = "electron-to-chromium";
      version = "1.4.410";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.410.tgz";
        sha512 = "Zz3WQOHepTpdUXt6h6LG1qAY0Tb1yh91YYHa4M63Hr6AJ4n/OVnANfP5dhYx2ZQLEL/T0Qeyebjz3kELUc32zQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.410"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2250";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2250.tgz";
      sha512 = "6uUQcdHgd8GycJaVX29cnGXH2khqy0gkpGb1heWJaitav1AcS7P9v9LOpqd5M/HnCD7j4OFfdKHFVSLZZiTw2Q==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.21.4"
