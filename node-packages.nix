...
let
  sources = {
    ...
    "electron-to-chromium-1.4.766" = {
      ...
      version = "1.4.766";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.766.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.766"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3631";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3631.tgz";
      sha512 = "zL7bxBSf+WD5pIXsIrAwVBObrgNyjprYVA0NEsYF+CbdBi6ufwCOKhens6Fs1NlzzCMfG5QZwqY+MpAgawSkvQ==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.24.2"
