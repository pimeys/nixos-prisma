...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1044";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1044.tgz";
      sha512 = "rVpMbADGYaojSFMtFZxKERzWQxcFASsTu8sInkxCtXcLlGH1cLSwF6y9yztKFt6EgN0ZhV7HSAKwSN8/o48zpA==";
    };
    dependencies = [
