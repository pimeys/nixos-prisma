...
let
  sources = {
    ...
    "@prisma/config-7.4.1" = {
      ...
      version = "7.4.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.4.1.tgz";
        sha512 = "vteSXm8N46bo3FW9MhPGVHAj+KRgrR6TWtlSk6GqToCKjTnOexXdPZyiDyEsfVW38YhqEmVl6w/6iHN8uYVJcw==";
      };
    };
    "@prisma/config-7.5.0-dev.17" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.5.0-dev.17";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.5.0-dev.17.tgz";
        sha512 = "70Nz69IqIspl+/rkzhcEC/h4ZVU0whtzSVHAFu6PRHCUVdhVz39fbPVQj+wY4hvqTpv49D0Z8Pc+UbBB4M3C/g==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-7.5.0-4.55ae170b1ced7fc6ed07a15f110549408c501bb3" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-7.5.0-4.55ae170b1ced7fc6ed07a15f110549408c501bb3.tgz";
        sha512 = "7J7kF0YCsY4blgM+VFq3rG1+mgFS8drZiKRKah1wsLN77t4ZS+6VwI89qTN6SlMakzlkd3giwQqDxr/utPgFXw==";
      };
    };
    "@prisma/prisma-schema-wasm-7.5.0-5.6bddf5676887cb38db09da3fa10a471fa01d51b0" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "7.5.0-5.6bddf5676887cb38db09da3fa10a471fa01d51b0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-7.5.0-5.6bddf5676887cb38db09da3fa10a471fa01d51b0.tgz";
        sha512 = "bG7Ba40VlbYJFA84Lh7m1S7Xj7Iyl4UbvqCYwOmqTV3/X3QexrQPUAXc0G8cEanwIV16/PCp001qFwjhkmlybA==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.4.1" = {
      ...
      version = "7.4.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.4.1.tgz";
        sha512 = "w67qWHGPKvmemfk7BjMaOqzMZGc0d4BByxoQsP0B93svH/O3NwnC4gfFN4RG7T/IYgnpn6i7xAQQtPx2cyI6hQ==";
      };
    };
    "@prisma/schema-files-loader-7.5.0-dev.17" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.5.0-dev.17";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.5.0-dev.17.tgz";
        sha512 = "pB8sG+6yJ3AAaZpPqrC3X4SqQINDIEjRCzHz5YHnzUPRq8uqg7vN/BjFzklbEhIuBbcXKA/J92kh7Q13Zso72w==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "31.5.15";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.5.15.tgz";
      sha512 = "LTqHPy3fAsRkF+VGB0Udi2J8cAehmfLqOM7ry0GMmlznWWO1i7l1fqpU5CPSX3FkJMvAbVUAGBVZ+HGDrAg0rg==";
    };
    dependencies = [
      ...
      sources."@prisma/config-7.4.1"
      sources."@prisma/prisma-schema-wasm-7.5.0-4.55ae170b1ced7fc6ed07a15f110549408c501bb3"
      sources."@prisma/schema-files-loader-7.4.1"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.5.18";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.5.18.tgz";
      sha512 = "p5q/Ns+n8azRzCz0RhpWPiMUnJlFG2dNcscRwXzHW+z/SBEJWNHBQy2a90rOuW2aeZ/Zl20ppZt4+yV5B3cbng==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.0"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.5.0-dev.17"
      sources."@prisma/prisma-schema-wasm-7.5.0-5.6bddf5676887cb38db09da3fa10a471fa01d51b0"
      sources."@prisma/schema-files-loader-7.5.0-dev.17"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
