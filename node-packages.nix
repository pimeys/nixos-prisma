...
let
  sources = {
    ...
    "@prisma/config-7.8.0-dev.4" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.8.0-dev.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.8.0-dev.4.tgz";
        sha512 = "P0TKq2zCeNC+p3bAr5zozsBb6sWd/5dlxJJFWe/3qLq+7PREwlVsN+POlg4tDUQEsCXzfNhNTs6dS24cUFlfTg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.8.0-dev.4" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.8.0-dev.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.8.0-dev.4.tgz";
        sha512 = "WkFNoVa2nodN/6SGvxQTvMa+M94uizjQ7Ll0+Vl0bWs5Hcj0TOML7HdJM62b+xVsWcZ0p9N3qV/F+aDNhA88/A==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.9.4";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.9.4.tgz";
      sha512 = "UY/gKLDfVKlrqNogLlusKDo/Bnq+lcu6lOYFCaYAf4k6ibjFR5ZYyZfLC6ktDVmdrKaC6VraeMw0bq8HH25vog==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.8.0-dev.4"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.8.0-dev.4"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.3.4"
