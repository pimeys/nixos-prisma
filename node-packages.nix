...
let
  sources = {
    ...
    "electron-to-chromium-1.4.781" = {
      ...
      version = "1.4.781";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.781.tgz";
        sha512 = "aBI40ltvcWJQDW+V803FY6HjXAfi5xCWzpa3vSM/NGg7GfKEvI7ftzW4Gb2XKTRO4WsxDG7YG8ykrr/pG9bkKQ==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.781"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3665";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3665.tgz";
      sha512 = "ab8VHwBuhfcz7+i3wAtJ0tUGMSPVO/wFFBgEcplxQg5JPDuLvkM1eZ5+DytbBy3E5suCj6NmtR4zup0H00tgKQ==";
    };
    dependencies = [
