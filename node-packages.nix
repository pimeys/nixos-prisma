...
let
  sources = {
    ...
    "@prisma/config-7.7.0-dev.3" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.7.0-dev.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.7.0-dev.3.tgz";
        sha512 = "HdaDc/WBrgx+gWHleAdsHu9+BJvzYqkI28s9o+0428bWucW7wzktEZwIVDyYhJrDsVcrJE4U4zAURkcU18Pk1A==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.7.0-dev.3" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.7.0-dev.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.7.0-dev.3.tgz";
        sha512 = "m/hBUYIUNbCANDxaAEiLB1sIqFS1r7kfb41I7RIj8BohawnbNyGersjbYQSzHMs+Kk7pgnrz9hBbOzTGhlv4bw==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.8.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.8.1.tgz";
      sha512 = "xtusFtJsMtmkLNEuZ0Trs1bJMXyF0TKVqjhtEbFs01k0x+ooYIREoar7152tUqrXpqYC2e5CR57j3a5Gqk+EqQ==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.2"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.7.0-dev.3"
      sources."@prisma/prisma-schema-wasm-7.6.0-1.75cbdc1eb7150937890ad5465d861175c6624711"
      sources."@prisma/schema-files-loader-7.7.0-dev.3"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
