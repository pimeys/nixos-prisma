...
let
  sources = {
    ...
    "@prisma/config-7.9.0-dev.4" = {
      ...
      version = "7.9.0-dev.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.9.0-dev.4.tgz";
        sha512 = "/8Oq1I48iCEXjkwsXvwTrVQmH+I7s6FSRvYomm5VEMh7L9ZtNZkwElVek/Eaxjv+iRu2J3upDTrQuLmL/Vq7AQ==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-7.8.0-6.3c6e192761c0362d496ed980de936e2f3cebcd3a" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-7.8.0-6.3c6e192761c0362d496ed980de936e2f3cebcd3a.tgz";
        sha512 = "yyKNwOSaxExepEI+pWwESbDNRSIhzE53PXD6YaEvY7cNl39qOIMjWJCIXMDwZQpt5ixDkL/sesWYg3XxCmBkZQ==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.9.0-dev.4" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.9.0-dev.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.9.0-dev.4.tgz";
        sha512 = "APiVjNmgHcJ4+mUxbR9JhhqN3wgXoVHr9xBdL/w2ATBLiioMts91Oit2ePRQWGqgqnW918INessR5jazYYpkZg==";
      };
    };
    ...
    "tinyexec-1.2.1" = {
      ...
      version = "1.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/tinyexec/-/tinyexec-1.2.1.tgz";
        sha512 = "iqo2IULiwCbMOLU9lVR5XMmXjWMh0ewJSFNOfFRHislSG31ESRnUg4awuiaFUcnINcz+oyQQY43QGh3rGn5aCA==";
      };
    };
    "universalify-2.0.1" = {
      name = "universalify";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "31.11.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.11.0.tgz";
      sha512 = "MdTwul5ZinbcWGCmTGK5X78Em/byyGhj1dGjd7uTu2/yb6HAF26ayVjAmGgL1yu6bI7mbBJl2o3KXTcaC+d54A==";
    };
    dependencies = [
      ...
      sources."@prisma/schema-files-loader-7.9.0-dev.4"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.10.5";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.10.5.tgz";
      sha512 = "YQdDSo5c5EIZMS8svCOPIHN8fKh/ng0ftG7rMWq0/VNlWWF8n/j1mzs2uN6rB4QcI+gBzQz/y/Np1IckxoP4Mg==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
