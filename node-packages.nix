...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7671";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7671.tgz";
      sha512 = "fjmVgKcUwepR6dtWIvOkR4l9PvmJDbZ2t2LJNbHkJxF+K6uQWoaGTlXv9AMAOSXneBGXH1hEsH3NX7NTjb91ug==";
    };
    dependencies = [
