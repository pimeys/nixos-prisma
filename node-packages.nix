...
let
  sources = {
    ...
    "@prisma/prisma-fmt-wasm-4.12.0-7.7a20cf1a4beb0a867a024f8c5bb3f1e48d184b3a" = {
      name = "_at_prisma_slash_prisma-fmt-wasm";
      packageName = "@prisma/prisma-fmt-wasm";
      version = "4.12.0-7.7a20cf1a4beb0a867a024f8c5bb3f1e48d184b3a";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-fmt-wasm/-/prisma-fmt-wasm-4.12.0-7.7a20cf1a4beb0a867a024f8c5bb3f1e48d184b3a.tgz";
        sha512 = "GjdC5F3MRuFKL7IVADFqNhlCAawleg/bW35VZcn2phB/k5JMIhicNbm8Qse2AmlTLABO+KGGQnP06PwGs1Ii6g==";
      };
    };
    ...
    "caniuse-lite-1.0.30001459" = {
      name = "caniuse-lite";
      packageName = "caniuse-lite";
      version = "1.0.30001459";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001459.tgz";
        sha512 = "WmuS7UmOyuMxDquiA3BUKrKPBcpaIHrFnlEzlIYKecjmHMABYsqp6eeZLjcLCW5aFb/dRJNYCiuGNEssQgLfaA==";
      };
    };
    "chalk-2.4.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.317" = {
      ...
      version = "1.4.317";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.317.tgz";
        sha512 = "JhCRm9v30FMNzQSsjl4kXaygU+qHBD0Yh7mKxyjmF0V8VwYVB6qpBRX28GyAucrM9wDCpSUctT6FpMUQxbyKuA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001459"
      sources."chalk-2.4.2"
      ...
      sources."electron-to-chromium-1.4.317"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1988";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1988.tgz";
      sha512 = "KAizAp99aIBY6jwGpb8x1Q96RUFkdOMKi6a0OEp2HIBPhzAoFgZuIHFu+YpYU32HWGCMyfgQA+hrgStmdgMgsg==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
      ...
      sources."@jridgewell/sourcemap-codec-1.4.14"
      sources."@jridgewell/trace-mapping-0.3.17"
      sources."@prisma/prisma-fmt-wasm-4.12.0-7.7a20cf1a4beb0a867a024f8c5bb3f1e48d184b3a"
      sources."@types/js-levenshtein-1.1.1"
      sources."aggregate-error-3.1.0"
      sources."ansi-regex-5.0.1"
      sources."ansi-styles-3.2.1"
