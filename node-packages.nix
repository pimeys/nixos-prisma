...
let
  sources = {
    ...
    "@prisma/schema-files-loader-5.15.0-dev.12" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "5.15.0-dev.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-5.15.0-dev.12.tgz";
        sha512 = "j6zVDUX3xYEsgmCRqVsFswCKUeUlNaTO955yfu283vUDv5/veuNpN0dFVSaC34wMxFG1xPaCdljxUAKxfZYgrA==";
      };
    };
    ...
    "caniuse-lite-1.0.30001619" = {
      ...
      version = "1.0.30001619";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30001619.tgz";
        sha512 = "SfolDuyDxyza6EUm112ugVI3gKIvUY/6+iddjvy00Ri7SCp34ZqM1p+U357VTLvOQ5FUo4MIFxbst03nKkDHUw==";
      };
    };
    "chalk-2.4.2" = {
      name = "chalk";
    ...
    "electron-to-chromium-1.4.772" = {
      ...
      version = "1.4.772";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.772.tgz";
        sha512 = "jFfEbxR/abTTJA3ci+2ok1NTuOBBtB4jH+UT6PUmRN+DY3WSD4FFRsgoVQ+QNIJ0T7wrXwzsWCI2WKC46b++2A==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-lite-1.0.30001619"
      sources."chalk-2.4.2"
      ...
      sources."electron-to-chromium-1.4.772"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3645";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3645.tgz";
      sha512 = "F9MxYH9IP1b5MBcENrZDfSuMW40mySM8iJi7GyTS7DkoV/xEVEwxeR5WvVR+RLy9QnTlTh12Jz6RSTy1VLebeQ==";
    };
    dependencies = [
      sources."@prisma/prisma-schema-wasm-5.15.0-3.97f638f5e0f371a1a553cf726f9d597bbe811bff"
      sources."@prisma/schema-files-loader-5.15.0-dev.12"
      sources."@types/js-levenshtein-1.1.3"
