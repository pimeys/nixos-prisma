...
let
  sources = {
    ...
    "@prisma/config-7.3.0-dev.1" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.3.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.3.0-dev.1.tgz";
        sha512 = "LMtaaFV6MYQqRG1hVdyO0h+V8tHVMVGtLp6xUxCIa7Va5l2UXVN1BJq0LGh13f3+ZWosXRafaQp8KRbMuF2Iiw==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.3.0-dev.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.3.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.3.0-dev.1.tgz";
        sha512 = "qqqk4NkCzfL8JYgkAbOY1PcbVuMAm0rBZ+dKxA5ZqsUseewsQPM8uVU6q8WwUOl3lD9SvcdEsiQYBZdYC++bZQ==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.3.6";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.3.6.tgz";
      sha512 = "8vKGpr43DfnyOlHpRdBbEMcCYYs+fgaiXe88GKINOMKry9M5CCNGX6+bi7prNoJPlwpR1AYghYJWx+HZAFlEow==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.28.5"
      sources."@babel/types-7.28.5"
      sources."@prisma/config-7.3.0-dev.1"
      sources."@prisma/prisma-schema-wasm-7.2.0-4.0c8ef2ce45c83248ab3df073180d5eda9e8be7a3"
      sources."@prisma/schema-files-loader-7.3.0-dev.1"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
