...
let
  sources = {
    ...
    "@prisma/config-6.6.0" = {
      ...
      version = "6.6.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.6.0.tgz";
        sha512 = "d8FlXRHsx72RbN8nA2QCRORNv5AcUnPXgtPvwhXmYkQSMF/j9cKaJg+9VcUzBRXGy9QBckNzEQDEJZdEOZ+ubA==";
      };
    };
    "@prisma/config-6.7.0-dev.6" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "6.7.0-dev.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-6.7.0-dev.6.tgz";
        sha512 = "UFEHKqP1i2UsncVenRRLZq4DTeQzR/oQhvEyvFnXehLkWFl/p5ZyDTNDhI5zlhAVgG63quxSr+qOG+vIeulIPQ==";
      };
    };
    ...
    "@prisma/prisma-schema-wasm-6.6.0-53.f676762280b54cd07c770017ed3711ddde35f37a" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.6.0-53.f676762280b54cd07c770017ed3711ddde35f37a.tgz";
        sha512 = "lyfyH5xm9hygB1mx083ofzfDwByghcMN2b3a3dG22HsYbWvHUatTtgxtzqgLH7m1HTTxf8UkMu0P6Q9VHfBW6A==";
      };
    };
    "@prisma/prisma-schema-wasm-6.7.0-3.4875a22186efbb39496ff418641e5f2887e4a4a6" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "6.7.0-3.4875a22186efbb39496ff418641e5f2887e4a4a6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-6.7.0-3.4875a22186efbb39496ff418641e5f2887e4a4a6.tgz";
        sha512 = "au3xi1zFRRe3GC1GdmEnqILHszIIcNWbFIr6U0hBfH7VKYWru/2YGtehS6dU0jucQqGJoKkmBycEuBFjRvGafg==";
      };
    };
    "@prisma/schema-files-loader-6.6.0" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.6.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.6.0.tgz";
        sha512 = "g8PWSF8cLKTfmgVHkg79T/9EKsGR+6HozqNpcAK2Avpe0MGwIXwTC/HW2Lc8kJfoPmMiCoh6Y5ClafMvp6nlPA==";
      };
    };
    "@prisma/schema-files-loader-6.7.0-dev.6" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "6.7.0-dev.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-6.7.0-dev.6.tgz";
        sha512 = "fBdl4e2MawQXhSv3KXl5yAMs4fqbUZedp3tIdfOCMoiS7jeH2y1C5NIJV14AXx0jYugEUe1QjI2El/kVmLeqvg==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "6.6.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-6.6.0.tgz";
      sha512 = "X7q9NZ+5NKB2ZeAPHbWLdtMIKcn3s1Na2FLnZ3z3BH8FDX23ZzyY3BUZZ9RVzElGGcDWuWePuucEzW4nR41Iww==";
    };
    dependencies = [
      sources."@prisma/config-6.6.0"
      sources."@prisma/prisma-schema-wasm-6.6.0-53.f676762280b54cd07c770017ed3711ddde35f37a"
      sources."@prisma/schema-files-loader-6.6.0"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.7446";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.7446.tgz";
      sha512 = "3Ya9wmJgCsrhVGZ6+YRoQ2nyNe6s+q4WY0DSILn1llWAA4Zluc10cIT1OjAMSML6GtxIiyrErP97yljARSfINA==";
    };
    dependencies = [
      sources."@prisma/config-6.7.0-dev.6"
      sources."@prisma/prisma-schema-wasm-6.7.0-3.4875a22186efbb39496ff418641e5f2887e4a4a6"
      sources."@prisma/schema-files-loader-6.7.0-dev.6"
      sources."@types/js-levenshtein-1.1.3"
      sources."debug-4.4.0"
      sources."esbuild-0.25.2"
      sources."esbuild-register-3.6.0"
