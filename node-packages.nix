...
let
  sources = {
    ...
    "electron-to-chromium-1.4.473" = {
      ...
      version = "1.4.473";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.473.tgz";
        sha512 = "aVfC8+440vGfl06l8HKKn8/PD5jRfSnLkTTD65EFvU46igbpQRri1gxSzW9/+TeUlwYzrXk1sw867T96zlyECA==";
      };
    };
    "emoji-regex-8.0.0" = {
      name = "emoji-regex";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.473"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.2519";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.2519.tgz";
      sha512 = "SxgpRcQ+NaUnypBHTN0RxK9QTL3BeDn2hUJBdKinWBUmdWvzpRrHLtBc/q6bAz9SshHSW6KXGlv7c85BMZikeQ==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.1"
      sources."@babel/code-frame-7.22.5"
