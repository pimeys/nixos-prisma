...
let
  sources = {
    ...
    "@prisma/prisma-fmt-wasm-4.7.1-1.272861e07ab64f234d3ffc4094e32bd61775599c" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-fmt-wasm/-/prisma-fmt-wasm-4.7.1-1.272861e07ab64f234d3ffc4094e32bd61775599c.tgz";
        sha512 = "o9oSp2c5yDWHn9TT2Ntv3cb6LuJKPBy32gTtipYH1D166KfKBy+1RkPySobWZCKV/TrkUGlcBn5vcQgRBHPvVA==";
      };
    };
    "@prisma/prisma-fmt-wasm-4.8.0-57.45e4f95ca2d2c726655add68f7af68bfb71f71ef" = {
      name = "_at_prisma_slash_prisma-fmt-wasm";
      packageName = "@prisma/prisma-fmt-wasm";
      version = "4.8.0-57.45e4f95ca2d2c726655add68f7af68bfb71f71ef";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-fmt-wasm/-/prisma-fmt-wasm-4.8.0-57.45e4f95ca2d2c726655add68f7af68bfb71f71ef.tgz";
        sha512 = "F7Qh5RV6xmSxUOKVg7QnObYk3JqAk5xHMT/a1BJQ2OkkSNRkkxVbYvLw+pfu/6/+usKwcc1YZ3RabWKj8I9pkw==";
      };
    };
    ...
    "ignore-5.2.3" = {
      ...
      version = "5.2.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/ignore/-/ignore-5.2.3.tgz";
        sha512 = "6BCmRZymdnasx6eA82MnzchMPSxA7ZwIYDLnUER0T9Xhf9XrsceU05+7nt9KPC1yjG3fDA1yk37yPlld3YX7oA==";
      };
    };
    "imurmurhash-0.1.4" = {
      name = "imurmurhash";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "4.7.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-4.7.1.tgz";
      sha512 = "0+4bmDWXr4Kda1wtECaphHv9bYv/HdVMiECXvvr8+JTOnJetd2ZulBpil31SyFttnspiclG5wu3fhik0z6S14w==";
    };
    dependencies = [
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1742";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1742.tgz";
      sha512 = "4LurlX+tqMlAH3rOTooUPdw8xtaqtkWIMinNrpI7ZAP0vJxdoTLdx0EXeW080JnksuuM7DJVeV6DUNONrozKHw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
      ...
      sources."@jridgewell/sourcemap-codec-1.4.14"
      sources."@jridgewell/trace-mapping-0.3.17"
      sources."@prisma/prisma-fmt-wasm-4.8.0-57.45e4f95ca2d2c726655add68f7af68bfb71f71ef"
      sources."@types/js-levenshtein-1.1.1"
      sources."aggregate-error-3.1.0"
      sources."ansi-regex-5.0.1"
      sources."ansi-styles-3.2.1"
