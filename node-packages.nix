...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1212";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1212.tgz";
      sha512 = "0j739JXVkIvhKVz08FQGW1sATWUlUEWOxeC70tpLnjYWJ0inYIKae+bhUyZPHrJn64M2v8YUEfOt1+mhSMZoaw==";
    };
    dependencies = [
