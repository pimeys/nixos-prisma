...
let
  sources = {
    ...
    "@prisma/config-7.5.0-dev.1" = {
      name = "_at_prisma_slash_config";
      packageName = "@prisma/config";
      version = "7.5.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/config/-/config-7.5.0-dev.1.tgz";
        sha512 = "smdTO6sSJzFV+FivhWNAtKJH2jAjAdDfzARXjpocDwGCYNxoMiv39YuT9VC+kl5poQ9bFqjPWIbij259H0jsOg==";
      };
    };
    ...
    "@prisma/schema-files-loader-7.5.0-dev.1" = {
      name = "_at_prisma_slash_schema-files-loader";
      packageName = "@prisma/schema-files-loader";
      version = "7.5.0-dev.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/schema-files-loader/-/schema-files-loader-7.5.0-dev.1.tgz";
        sha512 = "2B8N11PcWYmonDwIWC7PHKmy/quJwK4ZHNpB3MHTOktYevivKd/ts4L+Me/a3HplFAwykizZjMePLUMoxr1J2w==";
      };
    };
...
in
{
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.5.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.5.1.tgz";
      sha512 = "FDjj5b3PkRZEk2uudiJbgJtBOdgE2Ifxh+gA0e+BTrJRF5GezaWX2VdR+xQsDfADCkv2j/WHtQHtNnWQvj09+w==";
    };
    dependencies = [
      sources."@babel/helper-string-parser-7.27.1"
      sources."@babel/helper-validator-identifier-7.28.5"
      sources."@babel/parser-7.29.0"
      sources."@babel/types-7.29.0"
      sources."@prisma/config-7.5.0-dev.1"
      sources."@prisma/prisma-schema-wasm-7.4.0-20.ab56fe763f921d033a6c195e7ddeb3e255bdbb57"
      sources."@prisma/schema-files-loader-7.5.0-dev.1"
      sources."@standard-schema/spec-1.1.0"
      sources."@types/js-levenshtein-1.1.3"
      sources."c12-3.1.0"
      sources."chokidar-4.0.3"
