...
let
  sources = {
    ...
    "electron-to-chromium-1.4.213" = {
      ...
      version = "1.4.213";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.213.tgz";
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.213"
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.1285";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.1285.tgz";
      sha512 = "D1v/Dj7I/mnihBFTJ7LlB8H9FtrMq9xGNNb30uKolaDZStK2SWAyNlKgX98opEMGtED+uPLsmHUJZQdbRE/JMw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.2.0"
      sources."@babel/code-frame-7.18.6"
