...
let
  sources = {
    ...
    "@prisma/prisma-schema-wasm-5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.10.0-34.5a9203d0590c951969e85a7d07215503f4672eb9.tgz";
        sha512 = "fwWs1/LlZFnTtaJLxVWrQkSMeXNNJqC9DCNHSAOnLd6vxdrhOEWZuawMU/O//ef9nBKJWGzdzcX4Qnom9kUJvg==";
      };
    };
    "@prisma/prisma-schema-wasm-5.11.0-5.4308b705cc0694626ff407996f3145ddef0ad1c6" = {
      name = "_at_prisma_slash_prisma-schema-wasm";
      packageName = "@prisma/prisma-schema-wasm";
      version = "5.11.0-5.4308b705cc0694626ff407996f3145ddef0ad1c6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@prisma/prisma-schema-wasm/-/prisma-schema-wasm-5.11.0-5.4308b705cc0694626ff407996f3145ddef0ad1c6.tgz";
        sha512 = "6kTTcCQgTXtTycdj6Nrc1CCi2GdOLRgmUyDwSE2Vx2LQS7ektZstmOnRYj+4/xMPKAmxO1m7+hYN3Cbc5Kdzlg==";
      };
    };
...
in
{
  "@prisma/language-server" = nodeEnv.buildNodePackage {
    ...
    version = "5.10.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-5.10.2.tgz";
  ...
  "@prisma/language-server-dev" = nodeEnv.buildNodePackage {
    ...
    version = "31.0.3418";
    src = fetchurl {
      url = "https://registry.npmjs.org/@prisma/language-server/-/language-server-31.0.3418.tgz";
      sha512 = "oNtuGKCjXKzy5Sts5gpthwhkRP4e6ula7suoIHR5h/n/qRSZHswI8wjWVxXwcHdMuMhM3knTd+qgUI4qMaNrCw==";
    };
    dependencies = [
      sources."@ampproject/remapping-2.3.0"
      sources."@babel/code-frame-7.23.5"
      ...
      sources."@jridgewell/sourcemap-codec-1.4.15"
      sources."@jridgewell/trace-mapping-0.3.25"
      sources."@prisma/prisma-schema-wasm-5.11.0-5.4308b705cc0694626ff407996f3145ddef0ad1c6"
      sources."@types/js-levenshtein-1.1.3"
      sources."aggregate-error-3.1.0"
      sources."ansi-regex-5.0.1"
      sources."ansi-styles-3.2.1"
